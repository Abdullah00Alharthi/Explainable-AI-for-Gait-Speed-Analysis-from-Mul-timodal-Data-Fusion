"""
Gait Classification using Two-Branch 1D CNN with 5-Fold Subject-Wise Cross-Validation
-----------------------------------------------------------------------------------
This script loads gait-related data, performs subject-wise cross-validation,
trains a two-branch CNN model with early stopping, evaluates performance, and
visualizes results including normalized confusion matrices and t-SNE embeddings.
"""
