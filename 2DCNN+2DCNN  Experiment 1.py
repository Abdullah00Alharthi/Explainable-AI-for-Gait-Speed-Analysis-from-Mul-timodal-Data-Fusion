...
from keras.layers import Input, Dense, Activation, Flatten, Convolution1D, Dropout, MaxPooling1D, concatenate
...
# Model creation function with the new architecture
def create_model(input_shape, l):
    inp = Input(shape=(input_shape))
    t0 = Convolution1D(filters=96, kernel_size=2, strides=1, activation='relu', padding='same')(inp)
    t0 = MaxPooling1D(pool_size=2, strides=2, padding='same')(t0)

    t1 = Convolution1D(filters=48, kernel_size=2, strides=1, activation='relu', padding='same')(t0)
    t1 = MaxPooling1D(pool_size=3, strides=2, padding='same')(t1)
    t1 = Convolution1D(filters=24, kernel_size=2, strides=1, activation='relu', padding='same')(t1)
    t1 = MaxPooling1D(pool_size=3, strides=2, padding='same')(t1)
    t1 = Convolution1D(filters=12, kernel_size=2, strides=1, activation='relu', padding='same')(t1)
    t1 = MaxPooling1D(pool_size=3, strides=2, padding='same')(t1)
    t1 = Convolution1D(filters=6, kernel_size=2, strides=1, activation='relu', padding='same')(t1)
    t1 = MaxPooling1D(pool_size=3, strides=2, padding='same')(t1)
    
    t2 = Convolution1D(filters=48, kernel_size=2, strides=1, activation='relu', padding='same')(t0)
    t2 = MaxPooling1D(pool_size=3, strides=2, padding='same')(t2)
    t2 = Convolution1D(filters=24, kernel_size=2, strides=1, activation='relu', padding='same')(t2)
    t2 = MaxPooling1D(pool_size=3, strides=2, padding='same')(t2)
    t2 = Convolution1D(filters=12, kernel_size=2, strides=1, activation='relu', padding='same')(t2)
    t2 = MaxPooling1D(pool_size=3, strides=2, padding='same')(t2)
    t2 = Convolution1D(filters=6, kernel_size=2, strides=1, activation='relu', padding='same')(t2)
    t2 = MaxPooling1D(pool_size=3, strides=2, padding='same')(t2)
...
history_list = []
best_accuracy = 0
best_model_path = '2DCNN+2DCNN_EMG_best_model.h5'
mcc_list = []
fprs = []
tprs = []
aucs = []
